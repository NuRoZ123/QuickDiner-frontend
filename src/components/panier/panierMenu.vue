<template>
    <div class="absolute left-0 top-0 w-full h-screen bg-gray-900 bg-opacity-50 transition-opacity duration-500" v-show="panierMenu" @click="panierMenu = false"></div>
    <div class="absolute top-0 right-0 w-80 h-screen bg-white shadow-lg z-10 transform transition-all duration-500 overflow-hidden" :class="panierMenu ? 'translate-x-0' : 'translate-x-full'" style="overflow-x: hidden;">
